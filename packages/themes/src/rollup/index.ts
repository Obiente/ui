...
export { obienteTheme as default, obienteTheme } from './plugin';

// Re-export types
export type { ObienteThemeOptions, ThemeConfiguration, CompiledTheme, ThemeManifest, ThemeManifestEntry } from './types';
